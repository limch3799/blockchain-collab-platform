...
export const DISTRICTS: Record<string, Array<{ code: string; name: string }>> = {
  ...
  // 세종특별자치시
  '3600000000': [{ code: '3611000000', name: '세종특별자치시' }],
  ...
  '5200000000': [
    ...
    { code: '5272000000', name: '진안군' },
    { code: '5273000000', name: '무주군' },
    { code: '5274000000', name: '장수군' },
...
/**
 * 전체 주소 문자열 생성 (시/도 + 시/군/구)
 */
export const getFullAddress = (provinceCode: string, districtCode: string): string => {
