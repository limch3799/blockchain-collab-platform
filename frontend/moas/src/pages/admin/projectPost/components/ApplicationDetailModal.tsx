// src/pages/admin/projectPost/components/ApplicationDetailModal.tsx
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              <span
                className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${statusInfo.className}`}
              >
                {statusInfo.label}
              </span>
            </div>
            ...
            {application.deletedAt && (
              <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                <label className="block text-sm font-semibold text-red-700 mb-2">취소일</label>
                <p className="text-sm text-red-600">{formatDateTime(application.deletedAt)}</p>
              </div>
            )}
          </div>
        </div>
