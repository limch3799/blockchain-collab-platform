// src/pages/leader-project-list/components/LeaderContractStatusGuide.tsx
...
interface LeaderContractStatusGuideProps {
  currentFilter: ContractFilterType;
}

export function LeaderContractStatusGuide({ currentFilter }: LeaderContractStatusGuideProps) {
  const guideConfig: Record<ContractFilterType, ContractGuideConfig> = {
    ...
    BEFORE_START: {
      title: '계약 체결',
      description: '리더의 결제와 NFT 발행이 완료되었습니다.',
