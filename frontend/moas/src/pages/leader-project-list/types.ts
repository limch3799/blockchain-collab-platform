...
// 계약 필터 타입 (3개 탭으로 변경)
export type ContractFilterType = 'BEFORE_START' | 'IN_PROGRESS' | 'COMPLETED';
...
export const APPLICATION_FILTERS: FilterConfig[] = [
  ...
  { label: '계약제안', value: 'OFFERED' },
  { label: '거절됨', value: 'REJECTED' },
];

// 계약 현황 필터 (3개 탭으로 변경)
export const CONTRACT_FILTERS: FilterConfig[] = [
  { label: '계약 체결', value: 'BEFORE_START' },
  { label: '수행 중', value: 'IN_PROGRESS' },
